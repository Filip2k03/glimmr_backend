...
SECRET_KEY = 'django-insecure-%-dom#fbov@2=9qw&&oj-l0twk(zlek#zs1xz#nb6o_pu4mpyx'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticatedOrReadOnly', # Default permission for most views
    )
}
...
# Simple JWT Configuration (optional, customize as needed)
